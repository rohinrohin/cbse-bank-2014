...
void shape::boxa(int column1,int row1,int column2,int row2)
{
...
//=============================================================
//           FUNCTION TO DRAW STARTUP AND MAIN BOX
//=============================================================
 
void control::startup_box(void)
{
	clrscr();
	shape s;
	s.boxa(5, 2, 75, 24);
...
void control::startup_menu(void)
{
clrscr();
startup_box();
gotoxy(24, 4);
